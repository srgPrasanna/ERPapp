    ...
    is: 'sales-projection',
        ...
        autocompletearr:function(e)
          ...
          containerfunction:function()
          {
              ...
              this.containerparameter1=obj;
              this.containerrequesturl1="http://localhost:4000/containeridfetch1";
              this.$.containerajax1.generateRequest();
          },
          quantityfunction:function()
          {
            var obj={};
            obj.itemid=supplier_id;
            this.quantityparameter1=obj;
            this.quantityurl1="http://localhost:4000/quantityidfetch1";
            this.$.quantityajax1.generateRequest();
          },
          containerresponse1:function(e)
           {
              var containervalues1=e.detail.response.returnval;
              // alert(e.detail.response.returnval);
              this.containeridvalue=e.detail.response.returnval[0].containername;
              // alert(e.detail.response.returnval[0].containername);
           },
           quantityresponse1:function(e)
           {
        ...
        jsoninfoResponse:function(){
          ...
          confirm:function () {
            ...
            this.writeparam1=obj;
            this.$.insertajax1.generateRequest();
            document.querySelector("home-page").FnSetPage("sales-projection");
          },
